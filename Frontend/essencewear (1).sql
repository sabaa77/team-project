...
INSERT INTO `products` (`product_id`, `size`, `name`, `description`, `price`, `category_id`, `image_url`) VALUES
...
(10, 'S', 'Gucci Embroidered Cotton Hoodie', 'Gucci\'s House codes continue to evolve for the new season across relaxed jersey pieces. This regular fit hooded sweatshirt is presented in a cotton jersey and defined by a Gucci embroidery.', 950.00, 2, '\"../../GucciHoodie.png\"'),
...
(12, 'S', 'Balenciaga Flared Cargo Pants in Blue', 'Women\'s Flared Cargo Pants in Blue', 1690.00, 2, '\"../../BalenciagaPants.png\"'),
...
(14, 'S', 'Boys Gucci Printed Cotton Hoodie', 'The archival Web stripe appears throughout the Cruise 2025 children\'s collection in a varietyof iterations. Green and red trims across ready-to-wear, shoes and accessories create a sporty attitude, fit for every adventure. This children\'s classic fit sweatshirt is stated in cotton jersey and reveals a Gucci overlay Web print.', 285.00, 3, '\"../../BoysGucciHoodie.png\" '),
